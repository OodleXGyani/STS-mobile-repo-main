...
import { MarkerBar, Marker } from '../MonthlyReportsStyles';
...
export const FleetMarkerBar: React.FC<FleetMarkerBarProps> = ({ title, value, average, color, max }) => {
